    ...
    return (
        <aside style={{
            ...
            <div style={{
                ...
                <div style={{
                    width: 32, height: 32, borderRadius: 6, background: 'var(--az-blue)',
                ...
                <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--az-text)', lineHeight: 1.2 }}>Cloud Optimizer</div>
                    <div style={{ fontSize: 10, color: 'var(--az-text-2)', marginTop: 1 }}>ML-Powered Platform</div>
                </div>
            </div>
